      ...
      <div className="border-b border-border bg-gradient-to-b from-primary/5 via-background to-background py-12 sm:py-16">
        <div className="mx-auto max-w-5xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-base text-muted-foreground sm:text-lg">
            Providing quality products and everyday essentials sourced both locally & globally with uncompromised quality.
          </p>
      ...
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 sm:p-8 shadow-xs">
          ...
          <p className="mt-4 text-sm sm:text-base text-muted-foreground leading-relaxed">
            Welcome to <strong className="text-foreground">{siteName}</strong> — your premier destination for quality products across multiple categories at competitive prices. We started with a simple mission: to make modern, high-quality products accessible, enjoyable, and effortless for everyone.
          </p>
        ...
        <div className="rounded-2xl border border-primary/20 bg-gradient-to-r from-primary/10 via-primary/5 to-background p-6 sm:p-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Discover the latest trending products and deals.</p>
            </div>
          </div>
          <Link
            href="/products"
